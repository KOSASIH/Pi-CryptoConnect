...
def write_metrics(metrics):
    ...
    points = [
        Point("gpio_pin_state")
        .tag("pin", "1")
        .field("state", metrics["gpio_pin_1_state"]),
        Point("gpio_pin_state")
        .tag("pin", "2")
        .field("state", metrics["gpio_pin_2_state"]),
        Point("gpio_pin_state")
        .tag("pin", "3")
        .field("state", metrics["gpio_pin_3_state"]),
        Point("gpio_pin_on_count")
        .tag("pin", "1")
        .field("count", metrics["gpio_pin_1_on_count"]),
        Point("gpio_pin_on_count")
        .tag("pin", "2")
        .field("count", metrics["gpio_pin_2_on_count"]),
        Point("gpio_pin_on_count")
        .tag("pin", "3")
        .field("count", metrics["gpio_pin_3_on_count"]),
    ]
