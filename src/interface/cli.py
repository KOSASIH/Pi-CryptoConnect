...
if __name__ == "__main__":
    ...
    train_parser.add_argument(
        "--model_name", type=str, required=True, help="The name of the model to train."
    )
    train_parser.add_argument(
        "--tokenizer_name",
        type=str,
    ...
    train_parser.add_argument(
        "--num_epochs", type=int, default=3, help="The number of epochs."
    )

    infer_parser = subparsers.add_parser("infer", help="Infer a model.")
    infer_parser.add_argument(
        "--model_name", type=str, required=True, help="The name of the model to infer."
    )
    infer_parser.add_argument(
        "--tokenizer_name",
        type=str,
    ...
    infer_parser.add_argument(
        "--test_data_path", type=str, required=True, help="The path to the test data."
    )
    infer_parser.add_argument(
        "--batch_size", type=int, default=32, help="The batch size."
    )
    ...
    if args.command == "train":
        ...
        infer_model(
            args.model_name, args.tokenizer_name, args.test_data_path, args.batch_size
        )
    else:
