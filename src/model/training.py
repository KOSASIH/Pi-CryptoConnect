...
class ModelTrainer:
    def __init__(self, model_name, tokenizer_name, train_data_path, val_data_path, batch_size, learning_rate, num_epochs):
        ...
        self.preprocessor = DataPreprocessor(self.train_data_path, self.tokenizer_name, self.model_name)
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            with torch.no_grad():
                ...
                print(f'Epoch {epoch+1}/{self.num_epochs}, Val Loss: {total_val_loss:.4f}, Val Accuracy: {val_accuracy:.4f}')
