...
def get_unconfirmed_transactions(node_url: str) -> Dict:
    ...
    if response.status_code == 200:
        ...
        return {
            "error": f"Error getting unconfirmed transactions: {response.status_code}"
        }
...
def get_mempool_transaction_by_hash(node_url: str, hash: str) -> Dict:
    ...
    if response.status_code == 200:
        ...
        return {
            "error": f"Error getting mempool transaction by hash: {response.status_code}"
        }
...
def get_mining_block_by_height(node_url: str, height: int) -> Dict:
    ...
    if response.status_code == 200:
        ...
        return {
            "error": f"Error getting mining block by height: {response.status_code}"
        }
...
def get_mining_transaction_by_hash(node_url: str, hash: str) -> Dict:
    ...
    if response.status_code == 200:
        ...
        return {
            "error": f"Error getting mining transaction by hash: {response.status_code}"
        }
...
def get_mining_unconfirmed_transactions(node_url: str) -> Dict:
    ...
    if response.status_code == 200:
        ...
        return {
            "error": f"Error getting mining unconfirmed transactions: {response.status_code}"
        }
...
def get_mining_pending_transactions(node_url: str) -> Dict:
    ...
    if response.status_code == 200:
        ...
        return {
            "error": f"Error getting mining pending transactions: {response.status_code}"
        }
